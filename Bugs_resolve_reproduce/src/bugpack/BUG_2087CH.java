...
import Statpage_locators.Statpage_locators;

public class BUG_2087CH {
	   ...
	   //live start
...

		{
...

			{
				...
				driver.findElement(By.xpath("//a[@data-type='stop' and @data-job_name='BUG_2087']")).click();
...

	{
		...
		File excel = new File("C:\\System\\Automatiom_Exceldata\\BUGS_Auto_json\\Spreadsheet\\BUG_2087CH.xlsx");
