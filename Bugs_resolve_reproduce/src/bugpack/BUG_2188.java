...
public class BUG_2188 {
...

	{
	   ...
	   //live start
		...
		String s20 = driver.findElement(By.id("output_stream_stat_reconnect_count_0_0_0")).getText();
...

	{
		...
		String a = "Import Status  Job Name  Notification  Job Status"
				...
				+ "  Bitrate  Presets  Avg Bitrate  Sent data  Uptime  Reconnect";
		String b = a.replaceAll("  ", ",");

		System.out.println(b);

		File excel = new File("C:\\System\\Automatiom_Exceldata\\BUGS_Auto_json\\Spreadsheet\\BUG_2188.xlsx");
