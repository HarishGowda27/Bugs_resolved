...
public class BUG_2187CH {
...

	{
	   ...
	   //live start
		...
		//protocol type
		String s15 = driver.findElement(By.xpath("/html/body/div[2]/div/div[3]/div/div[6]/div[2]/div/div/div/div/div[1]/div/div[2]")).getText();
		//Playlist Name
...

		{
...

			{
				...
				driver.findElement(By.xpath("//a[@data-type='stop' and @data-job_name='Bug_2187']")).click();
...

	{
		...
		File excel = new File("C:\\System\\Automatiom_Exceldata\\BUGS_Auto_json\\Spreadsheet\\BUG_2187CH.xlsx");
